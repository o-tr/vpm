...
function App() {
  ...
  if (!manifests) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-zinc-900 text-lg text-white">
        Loading...
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-white flex items-center justify-center py-8 px-2">
      <div className="w-full max-w-2xl flex flex-col items-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-10 text-white drop-shadow text-center w-full">
